...
// Error:
//		When an input string is between 57-63 bytes long, I get an error due to the counter being a negative value..
//		Any Input Message betweeb this 56-63 range needs to be handled correctly to prevent errors
...
//	std::string input = "This text that im writingggggg currently is exactly 64 bits long"; // 50380F922E8F5CD2391F6D2B799882CEB816345C38FE7D0210F5ABD6B15950E5// WORKS [64]
	...
	// These Sets if strings dont work....
	std::string input = "hello world Good Morning, adding some more to this to f"; // 19f8b22aaf4b0dba87ffcfa65d55d3e2a0870b23c6ee9ccc796c91f77554d9e1 // DOESNT WORK [56]
